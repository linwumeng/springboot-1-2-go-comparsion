...
class Sync2000d200u extends SyncSimulation {
    users=200
    delay=2000
    repeatTimes=240
    startup()
...
// ASYNC 2000D
class Async2000d100u extends AsyncSimulation {
    users=500
    delay=2000
    repeatTimes=6
    startup()
...
// SYNC 2000D
class Sync2000d100u extends SyncSimulation {
    users=500
    delay=2000
    repeatTimes=6
    startup()
